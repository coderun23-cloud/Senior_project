  ...
  <body>
    ...
    <div class="page-content" style="background-color: white;">
      <div class="container-fluid">
        <button class="add-user-button mt-10" onclick="openAddUserModal()" >+ Add User</button>
        <h1 style=" font-family:Arial, Helvetica, sans-serif; font-weight:bolder;text-align: center;font-size:30px;margin-top:20px;">ALL USERS</h1>
        ...
        <div class="form-container" style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 30px; align-items: center;">
          <!-- Filter Form -->
          <form action="{{ url('add_user') }}" method="GET" style="display: flex; gap: 15px; align-items: center; flex-wrap: wrap;">
            ...
            <div style="flex: 1; margin-bottom: 30px;">
              ...
              <input type="text" name="search" id="search" placeholder="Enter name, email, or phone number"
                value="{{ request('search') }}"
                style="padding: 10px; font-size: 14px; width: 100%; border-radius: 5px; border: 1px solid #ccc; background-color: #f8f9fa;">
            </div>
            ...
            <div>
              ...
              <a 
              style=" text-decoration:none;padding: 10px 20px; background-color: #007bff; color: white; border: none; border-radius: 5px; font-size: 16px; cursor: pointer;" href="{{url('/add_user')}}">
              Reset
            </a>
