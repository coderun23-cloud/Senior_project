...
<div class="content">
<h1 style="font-weight: bolder; text-align: center; font-size: 32px; margin-top: 30px; color: #000000; display: flex; align-items: center; justify-content: center; gap: 10px;">
  <i class="fas fa-chart-line" style="color: green;"></i> Performance Tracking Table
</h1>
        <div class="form-container" style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 30px; align-items: center;">
          ...
          <form action="{{ url('Performance_Tracking') }}" method="GET" style="display: flex; gap: 15px; align-items: center; flex-wrap: wrap;">
            ...
            <div class=" ml-10"> 
              <a style="text-decoration: none;" class="btn btn-secondary" href="{{url('Performance_Tracking')}}">Reset</a>
            </div>
          ...
          <tbody>
            @foreach($users as $index => $user)
              <tr>
                ...
                <td>
                  <button style="background-color: green;" class="view-button" data-user-id="{{ $user->id }}" data-role="{{ $user->role }}">View Performance</button>
                </td>
