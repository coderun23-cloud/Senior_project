...
<div class="flex flex-col md:flex-row">
  <div style=" padding: 20px;"> <!-- Aded padding for better spacing -->
    <button type="button" style=" padding: 10px 20px; color: rgb(255, 255, 255); 
    border: none; border-radius: 5px; font-size: 16px; 
    cursor: pointer; background-color: green;" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addUserModal">
    + Add User
</button>
    ...
    <div class="form-container" style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 30px; align-items: center;">
      ...
      <form action="{{ url('add_user') }}" method="GET" style="display: flex; flex-wrap: wrap; gap: 15px; align-items: center; width: 100%;">
        ...
        <div style="display: flex; align-items: center; gap: 10px;">
          <button type="submit" style="padding: 10px 20px;     background-color: green; color: white; border: none; border-radius: 5px; font-size: 16px; cursor: pointer;">Apply Filters</button>
          ...
          <div class="modal-body">
              <form action="{{ url('user_store') }}" method="POST" enctype="multipart/form-data" class="modal-form">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="address" id="email" class="form-control" placeholder="Enter address" required>
                </div>
                  ...
                  <div class="mb-3">
                      ...
                      <input type="text" name="phone_number" id="phone_number" class="form-control" required placeholder="Enter phone number">
                  </div>
